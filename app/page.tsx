...
export default function Index({AllData, HealthData, EducationData,AnimalData} : any) {
  ...
  useEffect(() => {
    ...
    const getCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,filter);
  ...
  return (
    <HomeWrapper>
      ...
      <FilterWrapper>
        ...
        <Category onClick={() => setFilter("education")}>Education</Category>
        <Category onClick={() => setFilter("Animal")}>Animal</Category>
      </FilterWrapper>
