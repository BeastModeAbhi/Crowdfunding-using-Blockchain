...
export default function Detail({Data, DonationsData}:any) {
  ...
  return (
    <DetailWrapper>
      ...
      <RightContainer>
        ...
        <DonateSection>
          <Input value={amount} onChange={(e:any) => setAmount(e.target.value)} type="number" placeholder="Enter Amount To Donate" />
